...
const FilterSearch = ({ darkMode }) => {
  ...
  return (
    ...
    >
      ...
      <div className={`relative mx-12 lg:mx-0 md:mx-9 ${darkMode? "text-white" : "text-black"} `}>
        <input
          type="text"
          className={`lg:relative md:pl-[52px] lg:pl-[80px] pl-10 lg:-ml-10 pr-2 py-2 text-sm md:border-r-2  lg:border-r-2  focus:outline-none h-20 w-96 lg:w-[520px] lg:rounded-l-md md:rounded-l-md rounded-md md:w-56 lg:rounded-r-none md:rounded-r-none  ${darkMode? "  bg-[#121721]" : "bg-white "} ${darkMode? "border-gray-500" : " "}`}
      ...
      {/* filter by location */}
      <div className={`relative hidden md:flex md:-ml-9 lg:ml-0 ${darkMode? "text-white" : "text-black"}`}>
        <input
          type="text"
      ...
      <div className={`md:flex items-center mx-3 lg:mx-0 lg:align-middle hidden lg:relative md:relative rounded-r-md  md:mx-0   ${darkMode? "  bg-[#121721]" : "bg-white "}`}>
        <div
        ...
        >
          ...
          <div className={`mr-3 flex justify-between ml-14 font-bold md:items-center md:ml-2  ${darkMode? "text-white" : "text-black"}`}>
            <span
